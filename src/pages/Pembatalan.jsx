      ...
      <div className="popup-modal">
        ...
        <div className="popup-body">
          ...
          <div className="warning-box">
            <h4>Perhatian!</h4>
            <p>
              Dengan membatalkan permohonan ini, semua dokumen dan data yang
              telah disubmit akan dihapus dari sistem.
            </p>
            <p>
              Jika Anda ingin mengajukan permohonan yang sama di kemudian hari,
              Anda perlu mengisi formulir dan mengunggah dokumen dari awal.
            </p>
          </div>
        </div>

        <div className="popup-footer">
          <button className="btn-secondary" onClick={onClose}>Kembali</button>
