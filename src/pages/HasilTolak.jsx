    ...
    <div className="page-wrapper-hasil">
      <div className="main-card-container">
        ...
        <div className="status-header">
          <img src={CrossIcon} alt="Rejected Icon" className="hourglass-icon" />
        ...
        <div className="detail-section">
          ...
          <div className="date-status-grid">
            ...
            <div className="status-item">
              ...
              <span className="status-value-ditolak">{data.status || 'rejected'}</span>
            </div>
          </div>
        </div>
        ...
        <div className="approval-note-box">
          <div className="note-content">
            <h5 className="note-title">Alasan Penolakan</h5>
